...
var propertyExpr = __nccwpck_require__(435);
var tinyCase = __nccwpck_require__(923);
var toposort = __nccwpck_require__(889);
...
const yup_1 = __nccwpck_require__(281);
const lodash_1 = __nccwpck_require__(250);
const lineBreak = `&#10;`;
function htmlSafe(str) {
    return str.replace(/<html-safe>(.*?)<\/html-safe>/g, (_, p1) => (0, lodash_1.escape)(p1));
}
...
async function run() {
    ...
    const list = core.setOutput('message', [
        inputs.message,
        lineBreak,
        lineBreak,
